...
def merge(arrA, arrB):
    ...
    for i in range(0, elements):
        ...
        if arrAIndex > len(arrA)-1 and arrBIndex <= len(arrB)-1:
            print("IF STATEMENT 1 TRIGGERED")
        ...
        # if len(arrB) = 0:
            ...
            print("IF STATEMENT 2 TRIGGERED")
        ...
        # elif next element in arrA smaller or equal, add to merged array
            ...
            print("IF STATEMENT 3 TRIGGERED")
            merged_arr[i] = arrA[arrAIndex]
            # arrA.pop([0])
            arrAIndex += 1
        ...
        # else next element in arrB smaller, add to merged array
            ...
            print("IF STATEMENT 4 TRIGGERED")
            merged_arr[i] = arrB[arrBIndex]
            # arrB.pop([0])
            arrBIndex += 1
    
    print("RETURNED merged_arr:", merged_arr)
    return merged_arr
...
testArray = [6,23,5,1,6,7,9,7,3,1,35,1,5,5,6,434,341,41]
# testArray = [3,2,1,1]
